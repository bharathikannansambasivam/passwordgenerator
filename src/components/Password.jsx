...
function Password() {
  ...
  return (
    <div className="flex  h-screen w-screen justify-center items-center">
      <div className="flex justify-center    flex-col items-center font-JetBrains ">
        <h1 className="text-xl flex text-slate-300 mb-2  ">
          Password Generator
        </h1>{" "}
        <div
          className="bg-gray-600 flex  justify-between items-center w-full p-2
            mb-2 text-xl  "
        >
          {/* Search bar */}
          ...
          <div onClick={copytoclipboard} className="ml-1">
            <img src={copied ? tick : copy} alt="copy" />
          </div>
        </div>
        <div className="   bg-gray-600 flex flex-col justify-center items-center   p-3 px-4  ">
          {/* Check boxes */}
